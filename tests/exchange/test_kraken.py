...
async def test_stoploss_order_kraken(default_conf, mocker, ordertype, side, adjustedprice):
    api_mock = MagicMock()
    order_id = 'test_prod_buy_{}'.format(randint(0, 10 ** 6))
...
async def test_stoploss_order_dry_run_kraken(default_conf, mocker, side):
    api_mock = MagicMock()
