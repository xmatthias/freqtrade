...
async def test_weekly_handle(default_conf_usdt, update, ticker, fee, mocker, time_machine) -> None:
    ...
    telegram, freqtradebot, msg_mock = await get_telegram_testobject(mocker, default_conf_usdt)
...
async def test_telegram_forceexit_handle(
    ...
    patch_eventloop_threading(freqtradebot)
...
async def test_whitelist_static(default_conf, update, mocker) -> None:
    telegram, _freqtradebot, msg_mock = await get_telegram_testobject(mocker, default_conf)
...
async def test_send_msg_enter_notification(
...
async def test_send_msg_enter_cancel_notification(
...
async def test_send_msg_entry_fill_notification(
...
async def test_send_msg_exit_notification(default_conf, mocker) -> None:
...
async def test_send_msg_exit_fill_notification(
...
async def test_send_msg_strategy_msg_notification(default_conf, mocker) -> None:
    telegram, _, msg_mock = await get_telegram_testobject(mocker, default_conf)
...
async def test_send_msg_exit_notification_no_fiat(
...
async def test__exit_emoji(default_conf, mocker, msg, expected):
    del default_conf["fiat_display_currency"]
...
async def test_change_market_direction(default_conf, mocker, update) -> None:
    telegram, _, _msg_mock = await get_telegram_testobject(mocker, default_conf)
