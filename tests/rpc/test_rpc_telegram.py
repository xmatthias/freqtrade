...
async def test_send_msg_enter_notification(default_conf, mocker, caplog, message_type,
...
async def test_send_msg_exit_fill_notification(default_conf, mocker, direction,
                                               enter_signal, leverage) -> None:
