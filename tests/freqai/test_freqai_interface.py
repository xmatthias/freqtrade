...
async def test_extract_data_and_train_model_Standard(mocker, freqai_conf, model):
...
async def test_extract_data_and_train_model_MultiTargets(mocker, freqai_conf, model):
