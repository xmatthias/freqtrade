...
from tests.conftest import (create_mock_trades, get_mock_coro, get_patched_exchange,
...
async def test_PerformanceFilter_lookback(mocker, whitelist_conf, fee, caplog) -> None:
