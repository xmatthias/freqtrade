...
async def test_gen_pairlist_with_local_file(mocker, rpl_config):
    mock_file = MagicMock()
    ...
    result = await remote_pairlist.gen_pairlist([])
...
async def test_fetch_pairlist_timeout_keep_last_pairlist(mocker, rpl_config, caplog):
    rpl_config["pairlists"] = [
        {
            "method": "RemotePairList",
            "pairlist_url": "http://example.com/pairlist",
...
async def test_remote_pairlist_init_no_pairlist_url(mocker, rpl_config):
    rpl_config["pairlists"] = [
        {
            "method": "RemotePairList",
            "number_assets": 10,
...
async def test_remote_pairlist_init_no_number_assets(mocker, rpl_config):
    rpl_config["pairlists"] = [
        {
            "method": "RemotePairList",
            "pairlist_url": "http://example.com/pairlist",
