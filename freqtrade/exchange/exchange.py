...
class Exchange:
    ...
    async def create_dry_run_order(self, pair: str, ordertype: str, side: str, amount: float,
        ...
        dry_order = await self.check_dry_limit_order_filled(dry_order, immediate=True)
    ...
    async def stoploss(self, pair: str, amount: float, stop_price: float, order_types: Dict,
    ...
    @retrier_async
    async def fetch_positions(self, pair: str = None) -> List[Dict]:
        """
    ...
    async def get_rate(self, pair: str, refresh: bool,
                       ...
                       ticker: Optional[Ticker] = None) -> float:
        """
