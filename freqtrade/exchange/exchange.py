...
class Exchange:
    ...
    async def fetch_order(self, order_id: str, pair: str, params={}) -> Dict:
        if self._config['dry_run']:
    ...
    @retrier_async
    async def cancel_order(self, order_id: str, pair: str, params={}) -> Dict:
        if self._config['dry_run']:
            try:
    ...
    @retrier_async
    async def get_tickers(self, symbols: List[str] = None, cached: bool = False) -> Dict:
        """
        :param cached: Allow cached result
        :return: fetch_tickers result
        """
