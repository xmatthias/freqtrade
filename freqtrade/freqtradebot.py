...
#
    ...
    async def check_and_call_adjust_trade_position(self, trade: Trade):
        ...
        if stake_amount is not None and stake_amount > 0.0:
            ...
            await self.execute_entry(trade.pair, stake_amount, trade=trade, is_short=trade.is_short)
    ...
    async def get_valid_enter_price_and_stake(
        ...
        if price:
            ...
            # Calculate price
            proposed_enter_rate = await self.exchange.get_rate(
...
#
    ...
    async def _check_and_execute_exit(self, trade: Trade, exit_rate: float,
        ...
        if should_exit.exit_flag:
            ...
            await self.execute_trade_exit(trade, exit_rate, should_exit, exit_tag=exit_tag)
            return True
        return False
